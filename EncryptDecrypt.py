...
class SecureFileApp:
    def __init__(self, master):
        ...
        self.generate_key_button = tk.Button(master, text="Generate Key", command=self.generate_key, bg="#3498db", fg="white", height=2, width=20)
        self.generate_key_button.pack(pady=10)

        self.encrypt_button = tk.Button(master, text="Encrypt", command=self.encrypt, bg="#4CAF50", fg="white", height=2, width=20)
        self.encrypt_button.pack(pady=10)

        self.decrypt_button = tk.Button(master, text="Decrypt", command=self.decrypt, bg="#FF5733", fg="white", height=2, width=20)
